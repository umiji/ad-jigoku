 ...
 *
 * DESIGN.md §4,5,6,14,15,16 の YAML をそのまま TypeScript に落としたもの。
...
export { container, spacingScale, spacingUnit, type SpacingStep } from './spacing'
export { motion, type MotionDuration } from './motion'
